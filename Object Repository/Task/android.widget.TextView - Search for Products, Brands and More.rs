...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Search for Products, Brands and More</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Search for Products, Brands and More' or . = 'Search for Products, Brands and More')]</locator>
