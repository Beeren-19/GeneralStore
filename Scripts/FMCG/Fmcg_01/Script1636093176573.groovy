...
Mobile.swipe(433, 412, 450, 1889)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SKIP'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Use Current Address'), 0)

Mobile.swipe(443, 412, 450, 1889)

Mobile.tap(findTestObject('Object Repository/android.widget.Image - Fresh-Produce-500x500'), 0)
