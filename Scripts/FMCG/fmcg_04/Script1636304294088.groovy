...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Use Current Address (3)'), 0)

Mobile.swipe(443, 412, 450, 1889)

Mobile.tap(findTestObject('Object Repository/android.widget.Image - Fresh-Produce-500x500 (1)'), 0)
